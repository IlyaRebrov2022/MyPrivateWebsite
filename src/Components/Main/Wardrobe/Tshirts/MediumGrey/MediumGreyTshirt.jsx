...
import s from './MediumGreyTshirt.module.css'

const MediumGreyTshirt = () => {
    return (
        <div className={s.main}>
            ...
            <div>
                <div className={s.MediumGrey1}></div>
            </div>
            <div>
                <div className={s.MediumGrey2}></div>
            </div>
            ...
            <div>
                <div className={s.MediumGrey}>
                    <a href='/MediumGreyTshirt'>

                    </a>
                </div>
                <div className={s.IvyGreen}>
                    <a href='/IvyGreenTshirt'>
...
export default MediumGreyTshirt;